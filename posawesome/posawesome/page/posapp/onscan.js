	...
	var d = {
		attachTo: function (e, t) {
			...
			return (
				...
				!0 === t.reactToPaste &&
					e.addEventListener("paste", this._handlePaste, t.captureEvents),
		...
		setOptions: function (e, t) {
			...
			return (
				(e.scannerDetectionData.options = this._mergeOptions(
					e.scannerDetectionData.options,
					t,
				)),
		...
		_handleKeyUp: function (e) {
			d._isFocusOnIgnoredElement(this) ||
				(d._getNormalizedKeyNum(e) ==
					this.scannerDetectionData.options.scanButtonKeyCode &&
