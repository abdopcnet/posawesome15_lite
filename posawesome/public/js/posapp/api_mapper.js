...
const API_MAP = {
  ...
  SALES_INVOICE: {
    ...
    GET_PRINT_INVOICES:
      "posawesome.api.sales_invoice.get_print_invoices",
  },
  ...
  ITEM: {
    ...
    GET_BARCODE_ITEM: "posawesome.api.item.get_barcode_item", // Central unified barcode handler
  ...
  POS_CLOSING_SHIFT: {
    ...
    GET_PAYMENT_TOTALS:
      "posawesome.api.pos_closing_shift.get_payment_totals",
