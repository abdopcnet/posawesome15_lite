		...
		>
			...
			>
				<div
					...
					"
				>
					<span style="color: inherit; font-weight: 600; font-size: 10px">{{
						invoiceNumberText
					}}</span>
				</div>
				...
				>
					<i
						class="mdi mdi-wifi"
						:style="`font-size: 12px; color: ${pingIconColor}`"
					></i>
					...
					>
						...
						>
							<span
								...
								"
							>
								<i class="mdi mdi-printer" style="font-size: 18px"></i>جدول طباعه
								فاتورة
							</span>
							<button
								@click="printDialog = false"
								...
								<tbody>
									<tr
										...
										:style="
											...
											selectedPrintInvoice.name === invoice.name
