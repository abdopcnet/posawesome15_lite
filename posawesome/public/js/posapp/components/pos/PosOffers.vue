...
<template>
  ...
  <div v-if="offersEnabled" style="
    ...
    <div style="
      ...
      <div v-for="(offer, idx) in pos_offers" :key="idx" style="display: flex">
        <div style="
          ...
          :style="offer.offer_applied ? 'border-color: #4caf50; box-shadow: 0 4px 16px rgba(76, 175, 80, 0.3); background: linear-gradient(135deg, #ffffff 0%, #f1f8f4 100%)' : ''">
          
          <!-- =========================================== -->
          <!-- OFFER IMAGE WITH OVERLAY -->
          <!-- =========================================== -->
          <div style="position: relative; height: 70px; overflow: hidden">
            <img :src="offer.image || '/assets/posawesome/js/posapp/components/pos/placeholder-image.png'"
            ...
            <!-- Applied Badge -->
            <div v-if="offer.offer_applied" style="
              position: absolute;
              top: 4px;
              right: 4px;
          ...
          <div style="
            ...
            <!-- Discount Info -->
            <div style="flex: 1">
              <div v-if="offer.discount_percentage" style="
                display: flex;
              ...
              <div v-else-if="offer.discount_amount" style="
                display: flex;
                align-items: baseline;
                gap: 3px;
                padding: 3px 0">
              ...
              <label style="
                ...
                <span style="
                  ...
                  <span style="
                    ...
                    transition: 0.3s"
                    :style="offer.offer_applied ? 'transform: translateX(16px); background-color: white' : ''"></span>
                </span>
                <span style="
                  font-size: 0.65rem;
                  font-weight: 600;
    ...
    <div style="
      ...
      box-shadow: 0 -2px 8px rgba(0, 0, 0, 0.08);
      z-index: 10">
      <button @click="back_to_invoice" style="
        width: 100%;
