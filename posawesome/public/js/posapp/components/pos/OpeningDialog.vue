      ...
      <div style="
        ...
        <div style="padding: 12px; background: #fafbfc">
          ...
          <div style="margin-bottom: 12px">
            ...
            <select v-model="company" required style="
              width: 100%;
              padding: 8px 12px;
          ...
          <div style="margin-bottom: 12px">
            ...
            <select v-model="pos_profile" required style="
              width: 100%;
              padding: 8px 12px;
              border: 1px solid #d1d5db;
              border-radius: 6px;
          ...
          <div style="margin-bottom: 0">
            ...
            <div style="
              ...
              <!-- Table Body -->
              <div>
                <div v-for="(item, index) in payments_methods" :key="item.mode_of_payment" style="
                  display: grid;
                  grid-template-columns: 2fr 1fr;
                  ...
                  <div style="
                    ...
                    <div style="display: flex; align-items: center; gap: 6px">
                      <i class="mdi" :class="getPaymentIcon(item.mode_of_payment).icon"
                         :style="{ color: getPaymentIcon(item.mode_of_payment).color, fontSize: '14px' }"></i>
                      <span style="
                        font-weight: 500;
                        color: #334155;
                        font-size: 11px">
                    ...
                    <div style="
                      ...
                      <input 
                        ...
                        style="
                          ...
                          color: #1e293b"
                        @focus="event => { event.target.parentElement.style.borderColor = '#6366f1'; event.target.parentElement.style.boxShadow = '0 0 0 2px rgba(99, 102, 241, 0.1)' }"
                        @blur="event => { event.target.parentElement.style.borderColor = '#d1d5db'; event.target.parentElement.style.boxShadow = 'none' }" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div style="
          ...
          <button v-if="isOpeningAllowed" style="
            display: flex;
            align-items: center;
            gap: 4px;
            padding: 6px 12px;
