      ...
      <div @click.stop style="
        ...
        <div style="
          ...
          <div style="
            ...
            <button @click="invoicesDialog = false" style="
              position: absolute;
              top: 8px;
              right: 8px;
              background: none;
          ...
          <div style="
            ...
            <div style="
              ...
              <!-- Search Button -->
              <button @click="search_invoices" style="
                display: inline-flex;
                align-items: center;
                justify-content: center;
                padding: 8px 16px;
            ...
            <div style="flex: 1; min-height: 0">
              <div style="max-height: 60vh; overflow-y: auto">
                ...
                <!-- No Data -->
                <div v-else-if="dialog_data.length === 0" style="
                  display: flex;
                  flex-direction: column;
                  align-items: center;
                  justify-content: center;
                ...
                <table v-else style="
                  ...
                  <tbody>
                    <tr v-for="item in dialog_data" 
                      ...
                      <!-- Grand Total -->
                      <td style="padding: 10px; text-align: right; font-weight: 600; color: #1976d2">
