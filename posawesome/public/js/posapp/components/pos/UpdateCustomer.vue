  ...
  <div style="display: flex; justify-content: center; align-items: center">
    ...
    <div v-if="customerDialog" 
      ...
      <div @click.stop style="
        ...
        <!-- Modal Content -->
        <div style="background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 6px 16px rgba(0, 0, 0, 0.08)">
          ...
          <div style="
            ...
            <button @click="close_dialog" style="
          ...
          <div style="padding: 8px 10px">
            ...
            <div style="display: flex; gap: 6px; margin-bottom: 6px">
              <div style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <input type="text" v-model="tax_id" placeholder="Tax ID" style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
              ...
              <div style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <input type="text" v-model="mobile_no" placeholder="Mobile" style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
            ...
            <div style="display: flex; gap: 6px; margin-bottom: 6px">
              <div style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <input type="email" v-model="email_id" placeholder="Email" style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
            ...
            <div style="display: flex; gap: 6px; margin-bottom: 6px">
              <div style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <input type="text" v-model="referral_code" placeholder="Code" style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
            ...
            <div style="display: flex; gap: 6px; margin-bottom: 6px">
              <div style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <select v-model="group" required style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
              ...
              <div style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <select v-model="territory" required style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
            ...
            <div v-if="loyalty_program || loyalty_points" style="display: flex; gap: 6px; margin-bottom: 6px">
              <div v-if="loyalty_program" style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <input type="text" v-model="loyalty_program" readonly style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
              ...
              <div v-if="loyalty_points" style="flex: 1; min-width: 0; margin-bottom: 6px">
                ...
                <input type="text" v-model="loyalty_points" readonly style="
                  width: 100%;
                  padding: 5px 8px;
                  border: 1px solid #d1d5db;
                  border-radius: 4px;
        ...
        <div style="
          ...
          <!-- Submit Button -->
          <button @click="submit_dialog" style="
            display: inline-flex;
            align-items: center;
            gap: 4px;
            padding: 4px 10px;
            ...
            color: white">
            <i class="mdi mdi-check" style="font-size: 13px"></i> {{ customer_id ? 'Update' : 'Register' }}
          </button>
