    ...
    <div v-if="closingDialog" 
      ...
      <div @click.stop style="
        ...
        <div v-if="pos_profile" style="padding: 8px; background: #fafbfc">
          ...
          <div style="
            ...
            <div style="
              ...
              <div v-if="!pos_profile.posa_hide_expected_amount" style="
                padding: 6px 8px;
                font-size: 10px;
                font-weight: 600;
                color: #475569;
            ...
            <!-- Table Body -->
            <div>
              <div v-for="(item, index) in dialog_data.payment_reconciliation" 
                ...
                <div style="
                  ...
                  <div style="display: flex; align-items: center; gap: 6px">
                    <i class="mdi mdi-cash-multiple" 
                       style="font-size: 14px; color: #667eea"></i>
                ...
                <div style="
                  ...
                  <div v-else @click="item.editing = true" style="
                    cursor: pointer;
                    padding: 2px 4px;
                    border-radius: 3px;
                ...
                <div v-if="!pos_profile.posa_hide_expected_amount" style="
                  ...
                  <span style="
                    ...
                    font-size: 11px;
                    font-family: monospace"
                    :style="item.expected_amount - item.closing_amount > 0 ? 'color: #059669' : item.expected_amount - item.closing_amount < 0 ? 'color: #dc2626' : 'color: #64748b'">
        ...
        <div style="
          ...
          <div v-if="!isClosingAllowed && closingTimeMessage" style="
            display: flex;
            align-items: center;
            gap: 8px;
            color: #f59e0b;
