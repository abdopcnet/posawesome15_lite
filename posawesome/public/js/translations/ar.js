...
const posaTranslations = {
	ar: {
		...
		"User {} has been disabled. Please select valid user/cashier": "تم تعطيل المستخدم {}. يرجى اختيار مستخدم/أمين صندوق صالح",
		"Valid From": "صالح من",
		"Valid Upto": "صالح حتى",
		"Warehouse": "المستودع",
		"Type": "النوع",
		...
		"Applied": "تم التطبيق",
		"Apps": "التطبيقات",
		"Are you sure you want to close? All entered data will be lost.": "هل أنت متأكد أنك تريد الإغلاق؟ سيتم فقدان جميع البيانات المدخلة.",
		"Available": "المتوفر",
		...
		"Camera permission denied. Please allow camera access in your browser settings.": "تم رفض إذن الكاميرا. يرجى السماح بالوصول إلى الكاميرا من إعدادات المتصفح.",
		...
		"Database health affects overall system speed and reliability.": "صحة قاعدة البيانات تؤثر على سرعة النظام وموثوقيته.",
		"Decrease": "إنقاص",
		...
		"Event-loop lag measures how busy your browser is. Lower is better.": "Event-loop lag measures how busy your browser is. Lower is better.",
		...
		"Payment Request took too long to respond. Please try requesting for payment again": "استغرق طلب الدفع وقتًا طويلاً للاستجابة. يرجى إعادة المحاولة.",
		...
		"Payment submitted but print function could not be executed. Payment name not found.": "تم إرسال الدفع ولكن لم يتم تنفيذ الطباعة. لم يتم العثور على اسم الدفع.",
		"Payments": "المدفوعات",
		...
		"Tables": "الجداول",
		"The app stores data locally for offline use. This is called cache.": "يقوم التطبيق بتخزين البيانات محليًا للاستخدام في وضع عدم الاتصال. يُعرف ذلك بالذاكرة المخبأة.",
		...
		"Time": "الوقت",
		"Tip Clear cache regularly to free up space and keep the app fast.": "نصيحة امسح الذاكرة المخبأة بانتظام لتوفير المساحة والحفاظ على سرعة التطبيق.",
		"Tip Close unused tabs or apps to reduce lag.": "نصيحة أغلق علامات التبويب أو التطبيقات غير المستخدمة لتقليل التأخير.",
		"Tip Monitor slow queries and table size for optimal performance.": "نصيحة راقب الاستعلامات البطيئة وحجم الجداول للحصول على أداء مثالي.",
		...
		"Warning High lag may indicate heavy processing or browser slowness.": "تحذير التأخير العالي قد يشير إلى معالجة ثقيلة أو بطء في المتصفح.",
		...
		"his item": "هذا الصنف",
		"{0} has only {1} in stock. You requested {2}. Adjust quantity or restock.": "{0} لديه {1} فقط في المخزون. لقد طلبت {2}. يرجى تعديل الكمية أو إعادة التخزين.",
		"Stock update: {0} has {1} available. Adding {2} will bring the stock below zero.": "تحديث المخزون: {0} لديه {1} متاح. إضافة {2} ستؤدي إلى رصيد سالب.",
